	...
	*/
	...
	withStructuredOutput(outputSchema, config) {
		if (config?.method === void 0 || config?.method === "jsonSchema") {
			...
			const outputParser = outputSchemaIsZod ? __langchain_core_output_parsers.StructuredOutputParser.fromZodSchema(outputSchema) : new __langchain_core_output_parsers.JsonOutputParser();
